...
/*   Updated: 2024/01/18 15:54:44 by fserpe           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/minishell.h"

int	count_quote_2(s_pars *pars, t_sq *data)
{
	int	ret;
...
int	quote_is_closed(s_pars *pars, int l)
{
	int		target;
	int		i;
...
void	handle_quote_3(s_pars *pars, t_hq *data)
{
	data->i++;
...
void	handle_quote_2(s_pars *pars, t_hq *data)
{
...
char	*handle_quotes(s_pars *pars, int l)
{
	t_hq	*data;
	char	*ret;
