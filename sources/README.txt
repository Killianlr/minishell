...
pipex est en cours encore, quoi qu'il marche en vrai plutot bien, juste le test du "cat | cat | ls" OK
...
reste donc les heredocs a gerer (pas compliquer je pense vu que tu as deja des fonctions pour); OK (signaux a voir)
ainsi que les quotes et les variables d'environ je crois.

aussi petit leak quand on veux redir dans un outfile rien de bien mechant, je te laisse check ca. OK
